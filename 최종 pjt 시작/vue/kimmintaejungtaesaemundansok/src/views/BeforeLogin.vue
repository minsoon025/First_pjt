              ...
              <div class="text-center text-xxl-start">
                ...
                >
                  <div class="text-uppercase">
                    체력 증진 &middot; 체중 감량 &middot; 근력 증가
                  </div>
                </div>
                <div class="fs-3 fw-light text-muted">
                  I can help your health increase
                </div>
            ...
            <div class="col-xxl-8">
              <div class="text-center my-5">
                <h2 class="display-5 fw-bolder">
                  <span class="text-gradient d-inline">About our service</span>
                </h2>
                <p class="lead fw-light mb-4">
                  우리는 원하는 체력 증진 · 체중 감량 · 근력 증가를 할 수 있게
                  도와줍니다.
                </p>
                <p class="text-muted">
                  개인별 운동량과 운동 부위의 피로도를 가지고 운동을 추천해
                  줍니다. 퍼센트를 가지고 운동의 피로도를 고려해서 운동을 추천해
                  줍니다. 영상을 시청하면 운동량이 증가하고 잠에 들면 피로도가
                  감소합니다.
                </p>
                <div class="d-flex justify-content-center fs-2 gap-4">
                  <a class="text-gradient" href="https://twitter.com/"
                    ><i class="bi bi-twitter"></i
                  ></a>
                  <a class="text-gradient" href="https://www.linkedin.com/"
                    ><i class="bi bi-linkedin"></i
                  ></a>
                  <a class="text-gradient" href="https://github.com/"
    ...
    <footer class="bg-white py-4 mt-auto">
      <div class="container px-5">
        ...
        >
          <div class="col-auto">
            <div class="small m-0">
              Copyright &copy; 김민태정태세문단속 Website 2023
            </div>
          </div>
          <div class="col-auto">
            <a class="small" href="#!" onclick="alert('서울특별시 강남구 역삼동 테헤란로 212')"
              >오시는 길</a
            >
            <span class="mx-1">&middot;</span>
            <a class="small" href="#!" onclick="alert(' ssafy@ssafy.com 로 문의 바랍니다.')"
              >문의</a
            >
          </div>
        </div>
